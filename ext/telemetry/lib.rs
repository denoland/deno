...
fn setup_signal_handlers() {
  ...
  handler!(tokio::signal::windows::ctrl_break);
  handler!(tokio::signal::windows::ctrl_c);
  handler!(tokio::signal::windows::ctrl_close);
  handler!(tokio::signal::windows::ctrl_logoff);
  handler!(tokio::signal::windows::ctrl_shutdown);
}
