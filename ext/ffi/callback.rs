...
#[allow(clippy::non_send_fields_in_send_ty, reason = "pointers are used for FFI interop")]
...
struct UnsafeCallbackResource {
  ...
  #[allow(dead_code, reason = "closure must be kept alive to prevent C callback from dangling")]
