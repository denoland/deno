...
((window) => {
  ...
  class UnsafePointerView {
    ...
    getUint8(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_read_u8(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }

    getInt8(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_read_i8(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }

    getUint16(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_read_u16(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }

    getInt16(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_read_i16(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }

    getUint32(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_read_u32(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }

    getInt32(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_read_i32(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }

    getBigUint64(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_read_u64(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }

    getBigInt64(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_read_i64(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }

    getFloat32(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_read_f32(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }

    getFloat64(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_read_f64(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }

    getCString(offset = 0) {
      return core.unwrapOpResult(ops.op_ffi_cstr_read(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
      ));
    }
    ...
    copyInto(destination, offset = 0) {
      core.unwrapOpResult(ops.op_ffi_buf_copy_into(
        offset ? BigInt(this.pointer) + BigInt(offset) : this.pointer,
        destination,
  ...
  class UnsafePointer {
    static of(value) {
      ...
      return core.unwrapOpResult(ops.op_ffi_ptr_of(value));
    }
  }
  ...
  class UnsafeFnPointer {
    ...
    call(...parameters) {
      ...
      if (this.definition.nonblocking) {
        ...
        return core.unwrapOpResult(ops.op_ffi_call_ptr(
          this.pointer,
          this.definition,
          parameters,
        ));
  ...
  class UnsafeCallback {
    ...
    constructor(definition, callback) {
      ...
      const [rid, pointer] = core.unwrapOpResult(
        ops.op_ffi_unsafe_callback_create(
          definition,
          callback,
        ),
      );
    ...
    ref() {
      if (this.#refcount++ === 0) {
        core.unwrapOpResult(ops.op_ffi_unsafe_callback_ref(true));
      }
    }
    ...
    unref() {
      ...
      if (this.#refcount > 0 && --this.#refcount === 0) {
        core.unwrapOpResult(ops.op_ffi_unsafe_callback_ref(false));
      }
    }
  ...
  class DynamicLibrary {
    ...
    constructor(path, symbols) {
      [this.#rid, this.symbols] = core.unwrapOpResult(
        ops.op_ffi_load({ path, symbols }),
      );
      for (const symbol in symbols) {
        if ("type" in symbols[symbol]) {
          ...
          const value = core.unwrapOpResult(ops.op_ffi_get_static(
            this.#rid,
            name,
            type,
          ));
