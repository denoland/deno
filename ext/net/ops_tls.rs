...
use deno_tls::rustls_tokio_stream::ReadHalf;
use deno_tls::rustls_tokio_stream::WriteHalf;
use io::Read;
...
pub type TlsStream = deno_tls::rustls_tokio_stream::TlsStream;
...
impl TlsStreamResource {
  ...
  pub async fn handshake(
    ...
    let alpn_protocol = wr.get_alpn_protocol().map(|s| s.into());
