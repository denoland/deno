...
deno_core::extension!(
  ...
  ops = [
    ...
    http_next::op_http_get_request_raw_target,
    http_next::op_http_get_request_remote_addr<HTTP>,
    http_next::op_http_get_request_cancelled,
    http_next::op_http_get_request_http_minor_version,
    ...
    http_next::op_http_get_request_trailers,
    http_next::op_http_set_allow_half_open,
    http_next::op_http_reclaim_socket,
    http_next::op_http_set_response_status_message,
    http_next::op_http_set_response_force_close,
    http_next::op_http_set_response_close_delimited,
    http_next::op_http_set_node_auto_headers,
    http_next::op_http_set_response_interim,
    http_next::op_http_abort_response,
