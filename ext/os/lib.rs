...
pub fn exit(code: i32) -> ! {
  ...
  #[allow(clippy::disallowed_methods, reason = "exit is the intended behavior")]
...
fn op_set_env(
  ...
  #[allow(clippy::undocumented_unsafe_blocks, reason = "env::set_var is unsafe since Rust 1.66")]
  unsafe {
...
fn op_delete_env(
  ...
  #[allow(clippy::undocumented_unsafe_blocks, reason = "env::remove_var is unsafe since Rust 1.66")]
  unsafe {
    env::remove_var(key)
  };
  Ok(())
...
fn rss() -> u64 {
  ...
  #[allow(clippy::disallowed_methods, reason = "reading /proc/self requires direct fs access")]
