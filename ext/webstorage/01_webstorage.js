...
((window) => {
  ...
  class Storage {
    ...
    get length() {
      ...
      return core.op_webstorage_length(this[_persistent]);
    }
    ...
    key(index) {
      ...
      return core.op_webstorage_key(index, this[_persistent]);
    }
    ...
    getItem(key) {
      ...
      return core.op_webstorage_get(key, this[_persistent]);
    }
    ...
    removeItem(key) {
      ...
      core.op_webstorage_remove(key, this[_persistent]);
    }

    clear() {
      webidl.assertBranded(this, StoragePrototype);
      core.op_webstorage_clear(this[_persistent]);
    }
  }
