...
((window) => {
  ...
  const { defineEventHandler, setIsTrusted } = window.__bootstrap.event;
  ...
  const { newInnerRequest, mainFetch } = window.__bootstrap.fetch;
        ...
        if (this[_readyState] !== CLOSED) {
          ...
          for await (
            ...
            if (chunk === "") {
              ...
              console.error(JSON.stringify(field), JSON.stringify(value));
              ...
              switch (field) {
                ...
                case "id": {
                  if (!value.includes("\0")) {
                    console.error("new id:", JSON.stringify(value));
                    lastEventID = value;
                  }
                  break;
                }
                case "retry": {
                  ...
                  if (!isNaN(reconnectionTime) && isFinite(reconnectionTime)) {
          ...
          console.error("lastEventID is:", JSON.stringify(this[_lastEventID]));
          if (this[_lastEventID] !== "") {
            lastEventIDValue = this[_lastEventID];
          }
        }
