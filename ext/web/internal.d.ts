...
declare module "ext:deno_web/20_headers.js" {
  class Headers {
  }
...
declare module "ext:deno_web/21_formdata.js" {
...
declare module "ext:deno_web/22_body.js" {
  function mixinBody(
    prototype: any,
    bodySymbol: symbol,
...
declare module "ext:deno_web/26_fetch.js" {
