...
deno_core::extension!(deno_node,
  ...
  ops = [
    ...
    ops::udp::op_node_udp_connect,
    ops::udp::op_node_udp_disconnect,
    ops::udp::op_node_udp_getsockname,
    ops::udp::op_node_udp_send,
    ops::udp::op_node_udp_send_connected,
    ops::udp::op_node_udp_try_send_connected,
