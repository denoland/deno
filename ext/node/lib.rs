...
deno_core::extension!(deno_node,
  ...
  ops = [
    ...
    ops::http2::op_node_http2_client_connect<P>,
    ops::http2::op_node_http2_client_poll_connection,
    ops::http2::op_node_http2_client_request,
    ops::http2::op_node_http2_client_request_get_response,
    ops::http2::op_node_http2_client_request_get_response_body_chunk,
    ops::http2::op_node_http2_client_send_trailers,
    ops::http2::op_node_http2_client_request_get_response_trailers,
