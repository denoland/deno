...
deno_core::extension!(deno_node,
  ...
  lazy_loaded_esm = [
    dir "polyfills",
    "deps/balanced-match/index.js",
    "deps/brace-expansion/index.js",
    "deps/minimatch/unescape.ts",
    "deps/minimatch/escape.ts",
    "deps/minimatch/brace-expressions.ts",
    "deps/minimatch/assert-valid-pattern.ts",
    "deps/minimatch/ast.ts",
    "deps/minimatch/index.ts",
  ],
  options = {
