...
deno_core::extension!(deno_node,
  ...
  ops = [
    ...
    ops::util::op_node_set_trace_sigint,
    ops::util::op_node_start_sigint_watchdog,
    ops::util::op_node_stop_sigint_watchdog,
    ops::util::op_node_watchdog_has_pending_sigint,
