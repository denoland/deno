...
export function createWritableStdioStream(writer, name) {
  ...
  Object.defineProperties(stream, {
    columns: {
      enumerable: true,
      configurable: true,
      get: () => writer?.isatty() ? Deno.consoleSize?.().columns : undefined,
    },
    rows: {
      enumerable: true,
      configurable: true,
      get: () => writer?.isatty() ? Deno.consoleSize?.().rows : undefined,
    },
    isTTY: {
      enumerable: true,
      configurable: true,
    ...
    getWindowSize: {
      ...
      configurable: true,
      value: () =>
        writer?.isatty() ? Object.values(Deno.consoleSize?.()) : undefined,
    },
  });
