...
// Sleep helper used in sync busy-write retries. In Node this uses
// Atomics.wait on a SharedArrayBuffer; here we fall back to a busy spin
// because the test suite does not exercise EAGAIN/EBUSY paths and a real
// SAB requires --unstable.
function sleep(ms) {
