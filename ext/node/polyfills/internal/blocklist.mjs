...
(function () {
  ...
  const { op_blocklist_add_address, op_blocklist_add_range, op_blocklist_add_subnet, op_blocklist_check, op_blocklist_new, op_socket_address_get_serialization, op_socket_address_parse } = core.ops;
