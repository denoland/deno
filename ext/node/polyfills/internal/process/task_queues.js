...
// NB(bartlomieju): currently calling `process.nextTick()` causes failures
// during snapshot, so we disable it initially and enable it later in
// `__bootstrapNodeProcess()`.
...
function setHasTickScheduled(value) {
    core.setHasTickScheduled(value);
}
