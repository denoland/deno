...
// This file is a port of Node.js `lib/internal/zip/binary.js` (nodejs/node#64339).
...
const { BIGINT_MAX_SAFE_INTEGER } = core.loadExtScript(
  "ext:deno_node/internal/zip/constants.js",
);
...
function readSafeUint64(buffer, offset) {
  ...
  if (value > BIGINT_MAX_SAFE_INTEGER) {
    throw new ERR_ZIP_INVALID_ARCHIVE(
      "64-bit field exceeds the safe integer range",
    );
  }
  return Number(value);
}
