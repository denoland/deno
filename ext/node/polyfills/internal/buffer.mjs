...
(function () {
  ...
  const { op_base64_decode_into, op_base64_encode, op_base64_encode_from_buffer, op_is_ascii, op_is_utf8, op_mark_as_untransferable, op_node_buffer_compare, op_node_buffer_compare_offset, op_node_call_is_from_dependency, op_node_decode_utf8, op_transcode } = core.ops;
  ...
  const { encodings } = core.loadExtScript("ext:deno_node/internal_binding/string_decoder.ts");
  const { indexOfBuffer, indexOfNumber } = core.loadExtScript("ext:deno_node/internal_binding/buffer.ts");
  const { asciiToBytes, base64ToBytes, base64UrlToBytes, bytesToAscii, bytesToUtf16le, hexToBytes, utf16leToBytes } = core.loadExtScript("ext:deno_node/internal_binding/_utils.ts");
  ...
  const { ALL_PROPERTIES, getOwnNonIndexProperties, ONLY_ENUMERABLE } = core.loadExtScript("ext:deno_node/internal_binding/util.ts");
  const {
    validateBuffer,
    validateInteger,
