...
fn _resolve_path(base: &str, path: &str) -> String {
...
pub fn _uri_join(
  ...
  if ref_uri.scheme_part() != None {
    ...
    let joined_path = _resolve_path(base_path, ref_str);
...
fn _test_uri_join(base: &str, path: &str, expected: &str) {
...
fn test_uri_join_absolute_url_refer() {
  _test_uri_join("http://foo.com?a=b", "https://bar.com/", "https://bar.com/");
  _test_uri_join("http://foo.com/",
    "https://bar.com/?a=b",
    "https://bar.com/?a=b");
  _test_uri_join("http://foo.com/", "https://bar.com/?", "https://bar.com/?");
}

#[test]
fn test_uri_join_multiple_slashes() {
  _test_uri_join("http://foo.com/bar", "//baz", "http://foo.com/baz");
  _test_uri_join(
    "http://foo.com/bar",
    "///baz/quux",
...
fn test_uri_join_current_directory() {
  _test_uri_join("https://foo.com", ".", "https://foo.com/");
  _test_uri_join("https://foo.com/bar", ".", "https://foo.com/");
  _test_uri_join("https://foo.com/bar/", ".", "https://foo.com/bar/");
}

#[test]
fn test_uri_join_going_down() {
  _test_uri_join("http://foo.com", "bar", "http://foo.com/bar");
  _test_uri_join("http://foo.com/", "bar", "http://foo.com/bar");
  _test_uri_join("http://foo.com/bar/baz", "quux", "http://foo.com/bar/quux");
}

#[test]
fn test_uri_join_going_up() {
  _test_uri_join("http://foo.com/bar/baz", "../quux", "http://foo.com/quux");
  _test_uri_join(
    "http://foo.com/bar/baz",
    "../../../../../quux",
    "http://foo.com/quux",
  );
  _test_uri_join("http://foo.com/bar", "..", "http://foo.com/");
  _test_uri_join("http://foo.com/bar/baz", "./..", "http://foo.com/");
}
...
fn test_uri_join_path_with_escaping() {
  _test_uri_join("http://foo.com/foo%2fbar/", "../baz", "http://foo.com/baz");
  _test_uri_join(
  ...
  _test_uri_join("http://foo.com/foo%20bar/", "../baz", "http://foo.com/baz");
  _test_uri_join(
    "http://foo.com/foo",
    "../bar%2fbaz",
