...
- feat(cli): Add alert, confirm, and prompt (#7507)
- feat(cli): Add types for WeakRef/FinalizationRegistry (#8056)
- feat(cli): Stabilize Deno.fsync and Deno.fdatasync (#8038)
- feat(cli/bundle): Add support for --no-check (#8023)
- feat(cli/console): Inspect with colors regardless of Deno.noColor (#7778)
- feat(cli/doc): Support --import-map flag (#7821)
- feat(cli/fmt): Make --ignore flag stable (#7922)
- feat(cli/install): Add missing flags for deno install (#7601)
- feat(cli/repl): Add regex based syntax highlighter (#7811)
- feat(cli/repl): Add tab completion (#7827)
- feat(cli/test): Pass script args to test command (#8121)
...
- fix(cli): Use -rw-r--r-- for cache files (#8132)
- fix(cli): Use rid getter for stdio (#8014)
- fix(cli/console): Fix inspection of Function (#7930)
- fix(cli/console): Fix the test cases of function inspections (#7965)
...
- fix(cli/rt/websockets): Only add Sec-WebSocket-Protocol if it's not empty
  (#7936)
- fix(cli/test): Return error when awaiting unresolved promise (#7968)
...
- fix(op_crates/web): Apply backslash replacement to the pathname setter in URL
  (#7937)
- fix(op_crates/web): Expose event properties in console output (#8103)
- fix(op_crates/web): TextEncoder should return error message with original
  input (#8005)
- fix(op_crates/web): TextEncoder should throw RangeError (#8039)
- refactor(cli): Migrate info subcommand to new infrastructure (#7892)
- refactor(cli): Migrate run and cache to new infrastructure (#7996, #7981)
- refactor(cli): Rename --importmap to --import-map (#7032)
