...
- **--allow-net=\<allow-net\>** Allow network access. You can specify an
  optional, comma separated list of domains to provide a allowlist of allowed
  domains.
...
- **--allow-read=\<allow-read\>** Allow file system read access. You can specify
  ...
  allowlist of allowed file system access.
...
This example restricts file system access by allowlisting only the `/usr`
...
Try it out again with the correct permissions by allowlisting `/etc` instead:
...
This is an example on how to allowlist hosts/urls:
