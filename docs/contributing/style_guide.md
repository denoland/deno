...
Whenever you are using interfaces that are included in the arguments of an exported member, you must export the interface that is used.  Here is an example:
