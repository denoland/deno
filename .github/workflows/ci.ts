        ...
        const preRelease = step(
          ...
          },
          {
            ...
            run: [
              ...
              'bsdiff prev/deno target/release/deno "target/release/deno-${TARGET}.from-${PREV_VERSION}.bsdiff"',
              'cd target/release && shasum -a 256 "deno-${TARGET}.from-${PREV_VERSION}.bsdiff" > "deno-${TARGET}.from-${PREV_VERSION}.bsdiff.sha256sum"',
              'echo "Delta patch generated: deno-${TARGET}.from-${PREV_VERSION}.bsdiff"',
              'ls -lh "target/release/deno-${TARGET}.from-${PREV_VERSION}.bsdiff"',
            ],
          },
          {
