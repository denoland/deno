...
```sh
deno run --allow-net --allow-read https://deno.land/std@0.68.0/http/file_server.ts
...
import { Cookie, setCookie } from "https://deno.land/std@0.68.0/http/cookie.ts";
...
```ts
import { Response } from "https://deno.land/std@0.68.0/http/server.ts";
import { deleteCookie } from "https://deno.land/std@0.68.0/http/cookie.ts";
