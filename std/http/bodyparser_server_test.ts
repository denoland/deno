...
test(async function bodyParserGetFormDataMultipart(): Promise<void> {
  ...
  try {
    const res = await fetch("http://localhost:4500/BodyParser/getFormData/multipart", {
      method: "POST",
      headers: {
        "Content-Type": "multipart/form-data; boundary=----WebKitFormBoundaryF2FPVKMYJmaBhBnJ",
      },
      redirect: "follow", // manual, *follow, error
      referrer: "no-referrer", // no-referrer, *client
    ...
    const expectData =[{"name":"a","value":"001","type":"text"},{"name":"b","type":"file","filetype":"text/plain","filename":"file.txt","value":{"0":104,"1":101,"2":108,"3":108,"4":111,"5":32,"6":119,"7":111,"8":114,"9":108,"10":100,"11":33,"12":13,"13":10,"14":104,"15":101,"16":108,"17":108,"18":111,"19":32,"20":100,"21":101,"22":110,"23":111,"24":33}}];
    const bodyData = await res.json();
    assertEquals(bodyData, expectData);
  } finally {
    killFileServer();
