...
export default function randomBytes(size: number, cb?: (err: Error | null, buf?: Buffer) => void): void;
export default function randomBytes (
  ...
  if(typeof cb === "function"){
    try{
      ...
      //NodeJS nonsense
      //If the size is out of range it will throw sync, otherwise throw sync
