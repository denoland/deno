...
Deno.test({
  ...
  fn: () => {
    ...
    // TimeZone
    assertEquals(
      datetime.parse("2020-10-20T11:00:00.000Z", "yyyy-MM-dd'T'HH:mm:ss.SSSZ"),
      new Date("2020-10-20T11:00:00.000Z"),
    );
    assertEquals(
      datetime.parse(
        "2020-10-20T11:00:00.000+00",
    ...
    assertEquals(
      datetime.parse(
        "2020-10-20T11:00:00.000+00:00:00",
        "yyyy-MM-dd'T'HH:mm:ss.SSSZZZZZ",
      ),
      new Date("2020-10-20T11:00:00.000Z"),
    );
    ...
    assertEquals(
      datetime.parse(
        "2020-10-20T11:00:00.000+07:52:58",
        "yyyy-MM-dd'T'HH:mm:ss.SSSZZZZZ",
      ),
