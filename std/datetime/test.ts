...
Deno.test({
  ...
  fn: () => {
    ...
    assertThrows(() => datetime.parse("2020-10-20T11:00:00.000Z", "yyyy-MM-dd'T'HH:mm:ss.SSSx"), Error, `Unexpected character at position 25 in "yyyy-MM-dd'T'HH:mm:ss.SSSx`)
  },
})
