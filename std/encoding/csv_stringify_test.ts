...
const stringifyTestCases: (StringifyTestCase | StringifyTestCaseError)[] = [
  ...
  },
  {
    ...
    name: "Column: number accessor, Data: object",
  },
  {
  ...
  },
  {
    ...
    name: "Column: number accessor, Data: array",
  },
  {
    columns: [[1]],
    data: [{ 1: 1 }, { 1: 2 }],
    expected: `1${NEWLINE}1${NEWLINE}2${NEWLINE}`,
    name: "Column: array number accessor, Data: object",
  },
  {
    columns: [[1]],
    data: [["key", "foo"], ["key", "bar"]],
    expected: `1${NEWLINE}foo${NEWLINE}bar${NEWLINE}`,
    name: "Column: array number accessor, Data: array",
  },
  {
    columns: [[1, 1]],
  ...
  },
  {
    ...
    name: "Column: string accessor, Data: object",
  },
  {
    columns: [["value"]],
    data: [{ value: "foo" }, { value: "bar" }],
    expected: `value${NEWLINE}foo${NEWLINE}bar${NEWLINE}`,
    name: "Column: array string accessor, Data: object",
  },
  {
    columns: [["msg", "value"]],
    data: [{ msg: { value: "foo" } }, { msg: { value: "bar" } }],
