...
```ts title="readLines"
import { readLines } from "https://deno.land/std@0.68.0/io/mod.ts";
...
import { readStringDelim } from "https://deno.land/std@0.68.0/io/mod.ts";
import * as path from "https://deno.land/std@0.68.0/path/mod.ts";
...
```ts
import { StringReader } from "https://deno.land/std@0.68.0/io/mod.ts";
...
import {
  ...
  StringReader,
  StringWriter,
} from "https://deno.land/std@0.68.0/io/mod.ts";
...
```ts
import { fromStreamReader } from "https://deno.land/std@0.68.0/io/mod.ts";
...
```ts
import { fromStreamWriter } from "https://deno.land/std@0.68.0/io/mod.ts";
