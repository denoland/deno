  ...
  $root.main = (function() {
    ...
    main.BaseMsg = (function() {
      ...
      BaseMsg.fromObject = function fromObject(object) {
        if (object instanceof $root.main.BaseMsg) return object;
    ...
    main.Msg = (function() {
        ...
        if (message.startArgv != null && message.startArgv.length)
          for (var i = 0; i < message.startArgv.length; ++i)
            writer
              ...
              .string(message.startArgv[i]);
        if (
          message.startDebugFlag != null &&
          message.hasOwnProperty("startDebugFlag")
        )
          writer
            .uint32(/* id 12, wireType 0 =*/ 96)
            .bool(message.startDebugFlag);
        if (
          message.startMainJs != null &&
          message.hasOwnProperty("startMainJs")
        )
          writer
            .uint32(/* id 13, wireType 2 =*/ 106)
            .string(message.startMainJs);
        if (
          message.startMainMap != null &&
          message.hasOwnProperty("startMainMap")
        )
          writer
            .uint32(/* id 14, wireType 2 =*/ 114)
            .string(message.startMainMap);
        if (
          message.codeFetchModuleSpecifier != null &&
          message.hasOwnProperty("codeFetchModuleSpecifier")
        )
          writer
            .uint32(/* id 20, wireType 2 =*/ 162)
            .string(message.codeFetchModuleSpecifier);
        if (
          message.codeFetchContainingFile != null &&
          message.hasOwnProperty("codeFetchContainingFile")
        )
          writer
            .uint32(/* id 21, wireType 2 =*/ 170)
            .string(message.codeFetchContainingFile);
        if (
          message.codeFetchResModuleName != null &&
          message.hasOwnProperty("codeFetchResModuleName")
        )
          writer
            .uint32(/* id 30, wireType 2 =*/ 242)
            .string(message.codeFetchResModuleName);
        if (
          message.codeFetchResFilename != null &&
          message.hasOwnProperty("codeFetchResFilename")
        )
          writer
            .uint32(/* id 31, wireType 2 =*/ 250)
            .string(message.codeFetchResFilename);
        if (
          message.codeFetchResSourceCode != null &&
          message.hasOwnProperty("codeFetchResSourceCode")
        )
          writer
            .uint32(/* id 32, wireType 2 =*/ 258)
            .string(message.codeFetchResSourceCode);
        if (
          message.codeFetchResOutputCode != null &&
          message.hasOwnProperty("codeFetchResOutputCode")
        )
          writer
            .uint32(/* id 33, wireType 2 =*/ 266)
            .string(message.codeFetchResOutputCode);
        if (
          message.codeCacheFilename != null &&
          message.hasOwnProperty("codeCacheFilename")
        )
          writer
            .uint32(/* id 41, wireType 2 =*/ 330)
            .string(message.codeCacheFilename);
        if (
          message.codeCacheSourceCode != null &&
          message.hasOwnProperty("codeCacheSourceCode")
        )
          writer
            .uint32(/* id 42, wireType 2 =*/ 338)
            .string(message.codeCacheSourceCode);
        if (
          message.codeCacheOutputCode != null &&
          message.hasOwnProperty("codeCacheOutputCode")
        )
          writer
            .uint32(/* id 43, wireType 2 =*/ 346)
            .string(message.codeCacheOutputCode);
        if (message.exitCode != null && message.hasOwnProperty("exitCode"))
          writer.uint32(/* id 50, wireType 0 =*/ 400).int32(message.exitCode);
        if (
          message.timerStartId != null &&
          message.hasOwnProperty("timerStartId")
        )
          writer
            .uint32(/* id 60, wireType 0 =*/ 480)
            .int32(message.timerStartId);
        if (
          message.timerStartInterval != null &&
          message.hasOwnProperty("timerStartInterval")
        )
          writer
            .uint32(/* id 61, wireType 0 =*/ 488)
            .bool(message.timerStartInterval);
        if (
          message.timerStartDelay != null &&
          message.hasOwnProperty("timerStartDelay")
        )
          writer
            .uint32(/* id 62, wireType 0 =*/ 496)
            .int32(message.timerStartDelay);
        if (
          message.timerReadyId != null &&
          message.hasOwnProperty("timerReadyId")
        )
          writer
            .uint32(/* id 70, wireType 0 =*/ 560)
            .int32(message.timerReadyId);
        if (
          message.timerReadyDone != null &&
          message.hasOwnProperty("timerReadyDone")
        )
          writer
            .uint32(/* id 71, wireType 0 =*/ 568)
            .bool(message.timerReadyDone);
        if (
          message.timerClearId != null &&
          message.hasOwnProperty("timerClearId")
        )
          writer
            .uint32(/* id 80, wireType 0 =*/ 640)
            .int32(message.timerClearId);
        if (message.fetchReqId != null && message.hasOwnProperty("fetchReqId"))
          writer.uint32(/* id 90, wireType 0 =*/ 720).int32(message.fetchReqId);
        if (
          message.fetchReqUrl != null &&
          message.hasOwnProperty("fetchReqUrl")
        )
          writer
            .uint32(/* id 91, wireType 2 =*/ 730)
            .string(message.fetchReqUrl);
        if (message.fetchResId != null && message.hasOwnProperty("fetchResId"))
          writer
            .uint32(/* id 100, wireType 0 =*/ 800)
            .int32(message.fetchResId);
        if (
          message.fetchResStatus != null &&
          message.hasOwnProperty("fetchResStatus")
        )
          writer
            .uint32(/* id 101, wireType 0 =*/ 808)
            .int32(message.fetchResStatus);
        if (
          message.fetchResHeaderLine != null &&
          message.fetchResHeaderLine.length
        )
          for (var i = 0; i < message.fetchResHeaderLine.length; ++i)
            writer
              .uint32(/* id 102, wireType 2 =*/ 818)
              .string(message.fetchResHeaderLine[i]);
        if (
          message.fetchResBody != null &&
          message.hasOwnProperty("fetchResBody")
        )
          writer
            .uint32(/* id 103, wireType 2 =*/ 826)
            .bytes(message.fetchResBody);
        if (
          message.readFileSyncFilename != null &&
          message.hasOwnProperty("readFileSyncFilename")
        )
          writer
            .uint32(/* id 110, wireType 2 =*/ 882)
            .string(message.readFileSyncFilename);
        if (
          message.readFileSyncData != null &&
          message.hasOwnProperty("readFileSyncData")
        )
          writer
            .uint32(/* id 120, wireType 2 =*/ 962)
            .bytes(message.readFileSyncData);
        if (
          message.writeFileSyncFilename != null &&
          message.hasOwnProperty("writeFileSyncFilename")
        )
          writer
            .uint32(/* id 130, wireType 2 =*/ 1042)
            .string(message.writeFileSyncFilename);
        if (
          message.writeFileSyncData != null &&
          message.hasOwnProperty("writeFileSyncData")
        )
          writer
            .uint32(/* id 131, wireType 2 =*/ 1050)
            .bytes(message.writeFileSyncData);
        if (
          message.writeFileSyncPerm != null &&
          message.hasOwnProperty("writeFileSyncPerm")
        )
          writer
            .uint32(/* id 132, wireType 0 =*/ 1056)
            .uint32(message.writeFileSyncPerm);
        return writer;
      };
      ...
      Msg.verify = function verify(message) {
        ...
        if (
          message.fetchResHeaderLine != null &&
          message.hasOwnProperty("fetchResHeaderLine")
        ) {
        ...
        if (
          ...
          if (
            !(
              (message.fetchResBody &&
                typeof message.fetchResBody.length === "number") ||
              $util.isString(message.fetchResBody)
            )
          )
        ...
        if (
          ...
          if (
            !(
              (message.readFileSyncData &&
                typeof message.readFileSyncData.length === "number") ||
              $util.isString(message.readFileSyncData)
            )
          )
        ...
        if (
          ...
          if (
            !(
              (message.writeFileSyncData &&
                typeof message.writeFileSyncData.length === "number") ||
              $util.isString(message.writeFileSyncData)
            )
          )
      ...
      Msg.fromObject = function fromObject(object) {
        if (object instanceof $root.main.Msg) return object;
        ...
        if (object.startCwd != null) message.startCwd = String(object.startCwd);
        if (object.startArgv) {
        ...
        if (object.codeFetchResSourceCode != null)
          message.codeFetchResSourceCode = String(
            object.codeFetchResSourceCode
          );
        if (object.codeFetchResOutputCode != null)
          message.codeFetchResOutputCode = String(
        ...
        if (object.exitCode != null) message.exitCode = object.exitCode | 0;
        ...
        if (object.fetchResHeaderLine) {
          ...
          for (var i = 0; i < object.fetchResHeaderLine.length; ++i)
            message.fetchResHeaderLine[i] = String(
              object.fetchResHeaderLine[i]
            );
        }
        if (object.fetchResBody != null)
          if (typeof object.fetchResBody === "string")
            $util.base64.decode(
              object.fetchResBody,
              (message.fetchResBody = $util.newBuffer(
                $util.base64.length(object.fetchResBody)
              )),
              0
            );
        ...
        if (object.readFileSyncData != null)
          if (typeof object.readFileSyncData === "string")
            $util.base64.decode(
              object.readFileSyncData,
              (message.readFileSyncData = $util.newBuffer(
                $util.base64.length(object.readFileSyncData)
              )),
              0
            );
        ...
        if (object.writeFileSyncData != null)
          if (typeof object.writeFileSyncData === "string")
            $util.base64.decode(
              object.writeFileSyncData,
              (message.writeFileSyncData = $util.newBuffer(
                $util.base64.length(object.writeFileSyncData)
              )),
              0
            );
        ...
        if (message.command != null && message.hasOwnProperty("command"))
          object.command =
            options.enums === String
              ? $root.main.Msg.Command[message.command]
              : message.command;
        if (message.error != null && message.hasOwnProperty("error"))
          ...
          object.fetchResBody =
            options.bytes === String
              ? $util.base64.encode(
                  message.fetchResBody,
                  0,
                  message.fetchResBody.length
                )
              : options.bytes === Array
                ? Array.prototype.slice.call(message.fetchResBody)
                : message.fetchResBody;
        if (
          message.readFileSyncFilename != null &&
          message.hasOwnProperty("readFileSyncFilename")
          ...
          object.readFileSyncData =
            options.bytes === String
              ? $util.base64.encode(
                  message.readFileSyncData,
                  0,
                  message.readFileSyncData.length
                )
              : options.bytes === Array
                ? Array.prototype.slice.call(message.readFileSyncData)
                : message.readFileSyncData;
        if (
          message.writeFileSyncFilename != null &&
          message.hasOwnProperty("writeFileSyncFilename")
          ...
          object.writeFileSyncData =
            options.bytes === String
              ? $util.base64.encode(
                  message.writeFileSyncData,
                  0,
                  message.writeFileSyncData.length
                )
              : options.bytes === Array
                ? Array.prototype.slice.call(message.writeFileSyncData)
                : message.writeFileSyncData;
        if (
          message.writeFileSyncPerm != null &&
          message.hasOwnProperty("writeFileSyncPerm")
