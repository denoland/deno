...
pub static ALLOW_SCRIPTS_ARG: &[ArgDef] = &[
    ArgDef::new("allow-scripts")
        .long("allow-scripts")
        .action(ArgAction::Append)
        .num_args(NumArgs::ZeroOrMore)
        .require_equals()
...
pub static RUN_SUBCOMMAND: CommandDef = CommandDef {
    ...
    arg_groups: &[PERMISSION_ARGS, COMPILE_ARGS, INSPECT_ARGS, RUNTIME_MISC_ARGS, CPU_PROF_ARGS, ALLOW_SCRIPTS_ARG],
    subcommands: &[],
...
pub static EVAL_SUBCOMMAND: CommandDef = CommandDef {
    ...
    arg_groups: &[PERMISSION_ARGS, COMPILE_ARGS, INSPECT_ARGS, RUNTIME_MISC_ARGS],
    subcommands: &[],
    default_subcommand: None,
    trailing_var_arg: true,
    passthrough: false,
...
pub static CACHE_SUBCOMMAND: CommandDef = CommandDef {
    ...
    arg_groups: &[COMPILE_ARGS, INSPECT_ARGS, PERMISSION_ARGS, ALLOW_SCRIPTS_ARG],
    subcommands: &[],
    default_subcommand: None,
    trailing_var_arg: false,
    passthrough: false,
...
pub static JUPYTER_SUBCOMMAND: CommandDef = CommandDef {
    ...
    arg_groups: &[COMPILE_ARGS, RUNTIME_MISC_ARGS, PERMISSION_ARGS, UNSTABLE_ARGS],
    subcommands: &[],
    default_subcommand: None,
    trailing_var_arg: false,
    passthrough: false,
