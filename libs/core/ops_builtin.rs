...
builtin_ops! {
  ...
  ops_builtin_v8::op_immediate_check_start,
  ops_builtin_v8::op_immediate_check_stop,
  ops_builtin_v8::op_immediate_check_ref,
  ops_builtin_v8::op_immediate_check_unref,
