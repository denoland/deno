...
#[allow(private_interfaces, reason = "variants are implementation details not exposed publicly")]
...
impl<T, C: Clone> FutureArena<T, C> {
  ...
  #[inline]
  #[allow(private_bounds, reason = "bounds are implementation details not exposed publicly")]
