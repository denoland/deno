...
(function () {
  ...
  function processEvent_000(input, options = {}) {
  ...
  function transformBuffer_001(buffer, offset = 0) {
  ...
  function validateSchema_002(value, strict = false) {
    const errors = [];
  ...
  function formatOutput_003(data, indent = 2) {
    const lines = [];
    const prefix = "[op_003] ";
  ...
  function computeMetrics_004(samples) {
  ...
  function processEvent_005(input, options = {}) {
  ...
  function transformBuffer_006(buffer, offset = 0) {
    if (!(buffer instanceof Uint8Array)) {
  ...
  function validateSchema_007(value, strict = false) {
    const errors = [];
    if (value === null || value === undefined) {
      errors.push({
        field: "root",
  ...
  function formatOutput_008(data, indent = 2) {
    const lines = [];
    const prefix = "[op_008] ";
    if (Array.isArray(data)) {
      for (let i = 0; i < data.length; i++) {
  ...
  function computeMetrics_009(samples) {
    if (!Array.isArray(samples) || samples.length === 0) {
      return { mean: 0, min: 0, max: 0, count: 0, sum: 0 };
    }
    let sum = 0, min = Infinity, max = -Infinity;
  ...
  function processEvent_010(input, options = {}) {
  ...
  function transformBuffer_011(buffer, offset = 0) {
    if (!(buffer instanceof Uint8Array)) {
  ...
  function validateSchema_012(value, strict = false) {
    const errors = [];
    if (value === null || value === undefined) {
      errors.push({
        field: "root",
  ...
  function formatOutput_013(data, indent = 2) {
    const lines = [];
    const prefix = "[op_013] ";
    if (Array.isArray(data)) {
      for (let i = 0; i < data.length; i++) {
  ...
  function computeMetrics_014(samples) {
    if (!Array.isArray(samples) || samples.length === 0) {
      return { mean: 0, min: 0, max: 0, count: 0, sum: 0 };
    }
    let sum = 0, min = Infinity, max = -Infinity;
  ...
  function processEvent_015(input, options = {}) {
  ...
  function transformBuffer_016(buffer, offset = 0) {
    if (!(buffer instanceof Uint8Array)) {
  ...
  function validateSchema_017(value, strict = false) {
    const errors = [];
    if (value === null || value === undefined) {
      errors.push({
        field: "root",
  ...
  function formatOutput_018(data, indent = 2) {
    const lines = [];
    const prefix = "[op_018] ";
    if (Array.isArray(data)) {
      for (let i = 0; i < data.length; i++) {
  ...
  function computeMetrics_019(samples) {
    if (!Array.isArray(samples) || samples.length === 0) {
      return { mean: 0, min: 0, max: 0, count: 0, sum: 0 };
    }
    let sum = 0, min = Infinity, max = -Infinity;
  ...
  function processEvent_020(input, options = {}) {
  ...
  function transformBuffer_021(buffer, offset = 0) {
    if (!(buffer instanceof Uint8Array)) {
  ...
  function validateSchema_022(value, strict = false) {
    const errors = [];
    if (value === null || value === undefined) {
      errors.push({
        field: "root",
  ...
  function formatOutput_023(data, indent = 2) {
    const lines = [];
    const prefix = "[op_023] ";
    if (Array.isArray(data)) {
      for (let i = 0; i < data.length; i++) {
  ...
  function computeMetrics_024(samples) {
    if (!Array.isArray(samples) || samples.length === 0) {
      return { mean: 0, min: 0, max: 0, count: 0, sum: 0 };
    }
    let sum = 0, min = Infinity, max = -Infinity;
  ...
  function processEvent_025(input, options = {}) {
  ...
  function transformBuffer_026(buffer, offset = 0) {
    if (!(buffer instanceof Uint8Array)) {
  ...
  function validateSchema_027(value, strict = false) {
    const errors = [];
    if (value === null || value === undefined) {
      errors.push({
        field: "root",
  ...
  function formatOutput_028(data, indent = 2) {
    const lines = [];
    const prefix = "[op_028] ";
    if (Array.isArray(data)) {
      for (let i = 0; i < data.length; i++) {
  ...
  function computeMetrics_029(samples) {
    if (!Array.isArray(samples) || samples.length === 0) {
      return { mean: 0, min: 0, max: 0, count: 0, sum: 0 };
    }
    let sum = 0, min = Infinity, max = -Infinity;
  ...
  function processEvent_030(input, options = {}) {
  ...
  function transformBuffer_031(buffer, offset = 0) {
    if (!(buffer instanceof Uint8Array)) {
  ...
  function validateSchema_032(value, strict = false) {
    const errors = [];
    if (value === null || value === undefined) {
      errors.push({
        field: "root",
