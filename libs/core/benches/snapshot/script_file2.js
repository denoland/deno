...
(function () {
  ...
  function processEvent_200(input, options = {}) {
  ...
  function transformBuffer_201(buffer, offset = 0) {
  ...
  function validateSchema_202(value, strict = false) {
    const errors = [];
  ...
  function formatOutput_203(data, indent = 2) {
    const lines = [];
    const prefix = "[op_203] ";
  ...
  function computeMetrics_204(samples) {
  ...
  function processEvent_205(input, options = {}) {
  ...
  function transformBuffer_206(buffer, offset = 0) {
    if (!(buffer instanceof Uint8Array)) {
  ...
  function validateSchema_207(value, strict = false) {
    const errors = [];
    if (value === null || value === undefined) {
      errors.push({
        field: "root",
  ...
  function formatOutput_208(data, indent = 2) {
    const lines = [];
    const prefix = "[op_208] ";
    if (Array.isArray(data)) {
      for (let i = 0; i < data.length; i++) {
  ...
  function computeMetrics_209(samples) {
    if (!Array.isArray(samples) || samples.length === 0) {
      return { mean: 0, min: 0, max: 0, count: 0, sum: 0 };
    }
    let sum = 0, min = Infinity, max = -Infinity;
  ...
  function processEvent_210(input, options = {}) {
  ...
  function transformBuffer_211(buffer, offset = 0) {
    if (!(buffer instanceof Uint8Array)) {
  ...
  function validateSchema_212(value, strict = false) {
    const errors = [];
    if (value === null || value === undefined) {
      errors.push({
        field: "root",
  ...
  function formatOutput_213(data, indent = 2) {
    const lines = [];
    const prefix = "[op_213] ";
    if (Array.isArray(data)) {
      for (let i = 0; i < data.length; i++) {
  ...
  function computeMetrics_214(samples) {
    if (!Array.isArray(samples) || samples.length === 0) {
      return { mean: 0, min: 0, max: 0, count: 0, sum: 0 };
    }
    let sum = 0, min = Infinity, max = -Infinity;
  ...
  function processEvent_215(input, options = {}) {
  ...
  function transformBuffer_216(buffer, offset = 0) {
    if (!(buffer instanceof Uint8Array)) {
  ...
  function validateSchema_217(value, strict = false) {
    const errors = [];
    if (value === null || value === undefined) {
      errors.push({
        field: "root",
