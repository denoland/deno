  ...
  match config_type {
    ...
    CompilerOptionsType::Check { lib } => CompilerOptions::new(json!({
      ...
      "lib": match (lib, source_kind) {
        (TsTypeLib::DenoWindow, CompilerOptionsSourceKind::DenoJson) => vec!["deno.window", "node"],
        (TsTypeLib::DenoWindow, CompilerOptionsSourceKind::TsConfig) => vec!["deno.window", "dom", "node"],
        (TsTypeLib::DenoWorker, CompilerOptionsSourceKind::DenoJson) => vec!["deno.worker", "node"],
        (TsTypeLib::DenoWorker, CompilerOptionsSourceKind::TsConfig) => vec!["deno.worker", "dom", "node"],
      },
      "module": "NodeNext",
