...
pub struct DenoIsolate {
  pub isolate_: Option<v8::OwnedIsolate>,
  pub last_exception_: Option<String>,
  pub last_exception_handle_: v8::Global<v8::Value>,
  pub context_: v8::Global<v8::Context>,
  pub mods_: HashMap<deno_mod, ModuleInfo>,
  pub mods_by_name_: HashMap<String, deno_mod>,
  pub locker_: Option<v8::Locker>,
  ...
  pub recv_cb_: deno_recv_cb,
  pub snapshot_creator_: Option<v8::SnapshotCreator>,
  pub has_snapshotted_: bool,
  pub snapshot_: Option<SnapshotConfig>,
  pub next_dyn_import_id_: deno_dyn_import_id,
  pub dyn_import_cb_: deno_dyn_import_cb,
  pub dyn_import_map_:
