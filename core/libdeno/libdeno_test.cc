...
TEST(LibDenoTest, RecvReturnEmpty) {
  static int count = 0;
  auto recv_cb = [](auto _, auto cmd_id, auto buf, auto zero_copy_buf) {
...
TEST(LibDenoTest, RecvReturnBar) {
  static int count = 0;
  auto recv_cb = [](auto user_data, auto cmd_id, auto buf, auto zero_copy_buf) {
...
TEST(LibDenoTest, ZeroCopyBuf) {
  ...
  auto recv_cb = [](auto user_data, int cmd_id, deno_buf buf,
