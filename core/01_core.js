...
((window) => {
  ...
  const core = ObjectAssign(globalThis.Deno.core, {
    ...
    read: FunctionPrototypeBind(opAsync, null, "op_read"),
    readAll: FunctionPrototypeBind(opAsync, null, "op_read_all"),
    write: FunctionPrototypeBind(opAsync, null, "op_write"),
    writeAll: FunctionPrototypeBind(opAsync, null, "op_write_all"),
    readSync: (rid, buffer) => ops.op_read_sync(rid, buffer),
    writeSync: (rid, buffer) => ops.op_write_sync(rid, buffer),
    shutdown: FunctionPrototypeBind(opAsync, null, "op_shutdown"),
