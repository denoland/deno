...
pub static TYPESCRIPT_CODE: &str = include_str!("ts/typescript.js");
...
pub fn get_asset(name: &str) -> Option<&'static str> {
  macro_rules! inc {
    ($e:expr) => {
      Some(include_str!(concat!("ts/", $e)))
    };
  }
  match name {
    "system_loader.js" => inc!("system_loader.js"),
    "system_loader_es5.js" => inc!("system_loader_es5.js"),
...
pub fn op_fetch_asset<S: ::std::hash::BuildHasher>(
  ...
  move |_state: &mut CoreIsolateState,
    ...
    crate::Op::Sync(vec.into_boxed_slice())
  }
}
