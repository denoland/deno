...
pub mod tests {
  ...
  fn test_mods() {
    ...
    let loader = Arc::new(ModsLoader::default());
  ...
  fn dyn_import_err() {
    ...
    run_in_task(|cx| {
      let loader = Arc::new(DynImportErrLoader::default());
  ...
  */
  ...
  fn dyn_import_ok() {
    ...
    run_in_task(|cx| {
      let loader = Arc::new(DynImportOkLoader::default());
