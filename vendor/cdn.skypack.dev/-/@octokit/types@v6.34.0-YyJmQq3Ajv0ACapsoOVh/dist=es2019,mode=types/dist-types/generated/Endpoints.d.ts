...
declare type ExtractRequestBody<T> = "requestBody" extends keyof T
  ...
  : {};
declare type ToOctokitParameters<T> =
  & ExtractParameters<T>
...
declare type KnownJsonResponseTypes =
  | "application/json"
  | "application/scim+json"
  | "text/html";
declare type SuccessResponseDataType<Responses> = {
  [K in SuccessStatuses & keyof Responses]:
    GetContentKeyIfPresent<Responses[K]> extends never ? never
...
declare type ExtractOctokitResponse<R> = "responses" extends keyof R
...
export interface Endpoints {
  ...
  "POST /user/packages/{package_type}/{package_name}/restore{?token}":
    Operation<"/user/packages/{package_type}/{package_name}/restore", "post">;
  /**
  ...
  "POST {origin}/repos/{owner}/{repo}/releases/{release_id}/assets{?name,label}":
    Operation<"/repos/{owner}/{repo}/releases/{release_id}/assets", "post">;
  /**
