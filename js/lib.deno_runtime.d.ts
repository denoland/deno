...
// This makes it so that `declare`d variables aren't global by default.
export {};
...
declare global {
  ...
  export const atob: typeof textEncoding.atob;
  export const btoa: typeof textEncoding.btoa;
  export const fetch: typeof fetchTypes.fetch;
  export const clearTimeout: typeof timers.clearTimeout;
  export const clearInterval: typeof timers.clearInterval;
  export const console: consoleTypes.Console;
  export const setTimeout: typeof timers.setTimeout;
  export const setInterval: typeof timers.setInterval;
  export const location: domTypes.Location;
  export const onload: Function | undefined;
  export const crypto: Crypto;
  export const Blob: typeof blob.DenoBlob;
  export const File: domTypes.DomFileConstructor;
  export const CustomEventInit: typeof customEvent.CustomEventInit;
  export const CustomEvent: typeof customEvent.CustomEvent;
  export const EventInit: typeof event.EventInit;
  export const Event: typeof event.Event;
  export const EventListener: typeof eventTarget.EventListener;
  export const EventTarget: typeof eventTarget.EventTarget;
  export const URL: typeof url.URL;
  export const URLSearchParams: typeof urlSearchParams.URLSearchParams;
  export const Headers: domTypes.HeadersConstructor;
  export const FormData: domTypes.FormDataConstructor;
  export const TextEncoder: typeof textEncoding.TextEncoder;
  export const TextDecoder: typeof textEncoding.TextDecoder;
  export const Request: domTypes.RequestConstructor;
  export const Response: typeof fetchTypes.Response;
  export const performance: performanceUtil.Performance;
  export let onmessage: (e: { data: any }) => void;
  export const workerMain: typeof workers.workerMain;
  export const workerClose: typeof workers.workerClose;
  export const postMessage: typeof workers.postMessage;
  export const Worker: typeof workers.WorkerImpl;
  export const addEventListener: (
    type: string,
    callback: (event: domTypes.Event) => void | null,
    options?: boolean | domTypes.AddEventListenerOptions | undefined
  ) => void;
  export const dispatchEvent: (event: domTypes.Event) => boolean;
