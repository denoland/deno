...
test(function metrics() {
  ...
  assert(metrics1.opsDispatched > 0);
  assert(metrics1.opsCompleted > 0);
  ...
  assert(metrics2.opsDispatched > metrics1.opsDispatched);
  assert(metrics2.opsCompleted > metrics1.opsCompleted);
