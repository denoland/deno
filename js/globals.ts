...
import { sessionStorage, getLocaleStorage } from "./storage";
...
window.localStorage = {} as domTypes.Storage;
window.sessionStorage = {} as domTypes.Storage;
Object.defineProperty(window, "localStorage", {
  get: () => getLocaleStorage(),
  set: () => {}
});
