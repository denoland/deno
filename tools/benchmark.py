...
def main(argv):
    ...
    if os.name != 'nt':
        ...
        http_benchmark_info = http_benchmark(deno_path, hyper_hello_path,
                                                 core_http_bench_exe)
        new_data["req_per_sec"] = http_benchmark_info["req_per_sec"]
        new_data["max_latency"] = http_benchmark_info["max_latency"]
