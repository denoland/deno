...
pub fn init(rt: &mut deno_core::JsRuntime) {
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_set_viewport", op_webgpu_render_pass_set_viewport);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_set_scissor_rect", op_webgpu_render_pass_set_scissor_rect);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_set_blend_color", op_webgpu_render_pass_set_blend_color);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_set_stencil_reference", op_webgpu_render_pass_set_stencil_reference);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_execute_bundles", op_webgpu_render_pass_execute_bundles);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_end_pass", op_webgpu_render_pass_end_pass);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_set_bind_group", op_webgpu_render_pass_set_bind_group);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_push_debug_group", op_webgpu_render_pass_push_debug_group);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_pop_debug_group", op_webgpu_render_pass_pop_debug_group);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_insert_debug_marker", op_webgpu_render_pass_insert_debug_marker);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_set_pipeline", op_webgpu_render_pass_set_pipeline);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_set_index_buffer", op_webgpu_render_pass_set_index_buffer);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_set_vertex_buffer", op_webgpu_render_pass_set_vertex_buffer);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_draw", op_webgpu_render_pass_draw);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_draw_indexed", op_webgpu_render_pass_draw_indexed);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_draw_indirect", op_webgpu_render_pass_draw_indirect);
  super::super::reg_json_sync(rt, "op_webgpu_render_pass_draw_indexed_indirect", op_webgpu_render_pass_draw_indexed_indirect);
}
