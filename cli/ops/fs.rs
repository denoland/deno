...
pub fn init(i: &mut Isolate, s: &State) {
  i.register_op("op_chdir", s.core_op(json_op(s.stateful_op(op_chdir))));
  i.register_op("op_mkdir", s.core_op(json_op(s.stateful_op(op_mkdir))));
  ...
  i.register_op("op_utime", s.core_op(json_op(s.stateful_op(op_utime))));
}
