...
pub fn init(state: &mut deno_core::OpState) {
  super::reg_json_sync(state, "op_open_sync", op_open_sync);
  super::reg_json_async(state, "op_open_async", op_open_async);

  super::reg_json_sync(state, "op_seek_sync", op_seek_sync);
  super::reg_json_async(state, "op_seek_async", op_seek_async);

  super::reg_json_sync(state, "op_fdatasync_sync", op_fdatasync_sync);
  super::reg_json_async(state, "op_fdatasync_async", op_fdatasync_async);

  super::reg_json_sync(state, "op_fsync_sync", op_fsync_sync);
  super::reg_json_async(state, "op_fsync_async", op_fsync_async);

  super::reg_json_sync(state, "op_fstat_sync", op_fstat_sync);
  super::reg_json_async(state, "op_fstat_async", op_fstat_async);

  super::reg_json_sync(state, "op_umask", op_umask);
  super::reg_json_sync(state, "op_chdir", op_chdir);

  super::reg_json_sync(state, "op_mkdir_sync", op_mkdir_sync);
  super::reg_json_async(state, "op_mkdir_async", op_mkdir_async);

  super::reg_json_sync(state, "op_chmod_sync", op_chmod_sync);
  super::reg_json_async(state, "op_chmod_async", op_chmod_async);

  super::reg_json_sync(state, "op_chown_sync", op_chown_sync);
  super::reg_json_async(state, "op_chown_async", op_chown_async);

  super::reg_json_sync(state, "op_remove_sync", op_remove_sync);
  super::reg_json_async(state, "op_remove_async", op_remove_async);

  super::reg_json_sync(state, "op_copy_file_sync", op_copy_file_sync);
  super::reg_json_async(state, "op_copy_file_async", op_copy_file_async);

  super::reg_json_sync(state, "op_stat_sync", op_stat_sync);
  super::reg_json_async(state, "op_stat_async", op_stat_async);

  super::reg_json_sync(state, "op_realpath_sync", op_realpath_sync);
  super::reg_json_async(state, "op_realpath_async", op_realpath_async);

  super::reg_json_sync(state, "op_read_dir_sync", op_read_dir_sync);
  super::reg_json_async(state, "op_read_dir_async", op_read_dir_async);

  super::reg_json_sync(state, "op_rename_sync", op_rename_sync);
  super::reg_json_async(state, "op_rename_async", op_rename_async);

  super::reg_json_sync(state, "op_link_sync", op_link_sync);
  super::reg_json_async(state, "op_link_async", op_link_async);

  super::reg_json_sync(state, "op_symlink_sync", op_symlink_sync);
  super::reg_json_async(state, "op_symlink_async", op_symlink_async);

  super::reg_json_sync(state, "op_read_link_sync", op_read_link_sync);
  super::reg_json_async(state, "op_read_link_async", op_read_link_async);

  super::reg_json_sync(state, "op_ftruncate_sync", op_ftruncate_sync);
  super::reg_json_async(state, "op_ftruncate_async", op_ftruncate_async);

  super::reg_json_sync(state, "op_truncate_sync", op_truncate_sync);
  super::reg_json_async(state, "op_truncate_async", op_truncate_async);

  super::reg_json_sync(state, "op_make_temp_dir_sync", op_make_temp_dir_sync);
  ...
  super::reg_json_sync(state, "op_make_temp_file_sync", op_make_temp_file_sync);
  super::reg_json_async(
    state,
  ...
  super::reg_json_sync(state, "op_cwd", op_cwd);

  super::reg_json_sync(state, "op_futime_sync", op_futime_sync);
  super::reg_json_async(state, "op_futime_async", op_futime_async);

  super::reg_json_sync(state, "op_utime_sync", op_utime_sync);
  super::reg_json_async(state, "op_utime_async", op_utime_async);
}
