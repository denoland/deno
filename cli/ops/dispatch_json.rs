...
pub type JsonResult = Result<Value, DenoError>;
...
fn json_err(err: DenoError) -> Value {
  json!({
    "message": err.msg,
...
pub fn blocking_json<F>(is_sync: bool, f: F) -> Result<JsonOp, DenoError>
where
