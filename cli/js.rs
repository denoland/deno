...
#[test]
fn cli_snapshot() {
  let mut isolate = deno_core::CoreIsolate::new(deno_core::StartupData::Snapshot(deno_core::Snapshot::Static(CLI_SNAPSHOT)), false);
...
fn compiler_snapshot() {
  let mut isolate = deno_core::CoreIsolate::new(deno_core::StartupData::Snapshot(deno_core::Snapshot::Static(COMPILER_SNAPSHOT)), false);
  deno_core::js_check(isolate.execute(
    "<anon>",
    r#"
