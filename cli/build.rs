...
fn main() {
  ...
  // The generation of snapshots is quite slow and often unnecessary. Until we
  // figure out how to speed it up, or avoid it when unnecessary, this env var
  // provides an escape hatch for the impatient hacker in need of faster
  // incremental builds.
