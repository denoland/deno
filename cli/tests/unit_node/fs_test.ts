...
import { assert, assertThrows } from "../../../test_util/std/testing/asserts.ts";
...
Deno.test(
  ...
  () => {
    ...
    assertThrows(() => writeFileSync(filename, data, { encoding: 'utf16le' }), "The value \"utf16le\" is invalid for option \"encoding\"")
  }
)
