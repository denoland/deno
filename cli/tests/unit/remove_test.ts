...
import { assert, assertThrows, assertThrowsAsync } from "./test_util.ts";

const REMOVE_METHODS = ["remove", "removeSync"] as const;

Deno.test("removeDirSuccess", async function (): Promise<void> {
...
Deno.test("removeFileSuccess", async function (): Promise<void> {
  for (const method of REMOVE_METHODS) {
    // REMOVE FILE
...
Deno.test("removeFileByUrl", async function (): Promise<void> {
  for (const method of REMOVE_METHODS) {
    // REMOVE FILE
    const enc = new TextEncoder();
    const data = enc.encode("Hello");
...
Deno.test("removeFail", async function (): Promise<void> {
  for (const method of REMOVE_METHODS) {
    // NON-EMPTY DIRECTORY
...
Deno.test("removeDanglingSymlinkSuccess", async function (): Promise<void> {
  for (const method of REMOVE_METHODS) {
...
Deno.test("removeValidSymlinkSuccess", async function (): Promise<void> {
  for (const method of REMOVE_METHODS) {
...
Deno.test("removeAllDirSuccess", async function (): Promise<void> {
  for (const method of REMOVE_METHODS) {
    // REMOVE EMPTY DIRECTORY
...
Deno.test("removeAllFileSuccess", async function (): Promise<void> {
  for (const method of REMOVE_METHODS) {
    // REMOVE FILE
    const enc = new TextEncoder();
    const data = enc.encode("Hello");
...
if (Deno.build.os === "windows") {
  Deno.test("removeFileSymlink", async function (): Promise<void> {
  ...
  Deno.test("removeDirSymlink", async function (): Promise<void> {
    const symlink = Deno.run({
...
Deno.test("removeAllFail", async function (): Promise<
  void
> {
  for (const method of REMOVE_METHODS) {
    // NON-EXISTENT DIRECTORY/FILE
...
Deno.test("removePerm", async function (): Promise<
  void
> {
...
Deno.test("removeAllPerm", async function (): Promise<
  void
> {
  await Deno.permissions.revoke({ name: "write" });
