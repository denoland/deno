...
Deno.test("renameSyncSuccess", function (): void {
...
Deno.test("renameSuccess", async function (): Promise<void> {
  const testDir = Deno.makeTempDirSync();
  const oldpath = testDir + "/oldpath";
  const newpath = testDir + "/newpath";
  Deno.mkdirSync(oldpath);
...
Deno.test("renameSyncReadPerm", async function (): Promise<void> {
...
Deno.test("renameSyncWritePerm", async function (): Promise<void> {
