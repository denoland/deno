...
Deno.test("watchFsInvalidPath", function () {
...
Deno.test("watchFsBasic", async function (): Promise<void> {
...
Deno.test("watchFsReturn", async function (): Promise<void> {
  const testDir = await Deno.makeTempDir();
  const iter = Deno.watchFs(testDir);
...
Deno.test("watchFsPermissions", async function (): Promise<void> {
