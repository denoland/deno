...
Deno.test("fdatasyncSyncSuccess", function (): void {
...
Deno.test("fdatasyncSuccess", async function (): Promise<void> {
...
Deno.test("fsyncSyncSuccess", function (): void {
...
Deno.test("fsyncSuccess", async function (): Promise<void> {
