...
itest!(cjs_esmodule_export_not_exported {
  args:
    "run --allow-read --unstable --quiet npm/cjs_esmodule_export_not_exported/main.js",
  output: "npm/cjs_esmodule_export_not_exported/main.out",
  envs: env_vars(),
  http_server: true,
});
