...
<y>Docs</>: <c>https://docs.deno.com/go/permissions</>
  ...
  <g>-N, --allow-net[=<<IP_OR_HOSTNAME>...]</>    Allow network access (both inbound and outbound). Optionally specify allowed IP addresses and host names, with ports as necessary. Mutually exclusive with --allow-net-connect / --allow-net-listen.
