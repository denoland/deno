...
impl Worker {
  pub fn new(
    ...
    let isolate = Arc::new(Mutex::new(deno::Isolate::new(startup_data, false)));
    {
      ...
      i.register_op(
        "get_random_values",
        state_.cli_op(json_op(random::op_get_random_values)),
      );
      i.register_op(
        "global_timer_stop",
        state_.cli_op(json_op(timers::op_global_timer_stop)),
      );
      i.register_op(
        "global_timer",
      ...
      i.register_op(
        "create_worker",
        state_.cli_op(json_op(workers::op_create_worker)),
      );
      i.register_op(
      ...
      i.register_op(
        "host_post_message",
        state_.cli_op(json_op(workers::op_host_post_message)),
      );
      i.register_op(
        "host_get_message",
        state_.cli_op(json_op(workers::op_host_get_message)),
      );
      ...
      i.register_op("cwd", state_.cli_op(json_op(fs::op_cwd)));
      i.register_op(
        "fetch_asset",
