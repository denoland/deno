...
impl PrettyCoverageReporter {
    ...
    pub fn visit_coverage(&mut self, script_coverage: &ScriptCoverage, script_source: &str) {
...
pub fn report_coverages(dir: &PathBuf, quiet: bool, exclude: Vec<Url>) -> Result<(), AnyError> {
