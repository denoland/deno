...
pub const OP_DETAILS: phf::Map<&'static str, [&'static str; 2]> = phf_map! {
  ...
  "op_flock_async" => ["lock a file", "awaiting the result of a `Deno.FsFile.lock` call"],
  ...
  "op_funlock_async" => ["unlock a file", "awaiting the result of a `Deno.FsFile.unlock` call"],
