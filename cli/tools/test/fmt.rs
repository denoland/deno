...
fn pretty_resource_name(
  ...
  let (name, action1, action2) = match name {
    ...
    "Tls listener" => ("A TLS listener", "opened", "closed"),
    "Unix listener" => ("A Unix listener", "opened", "closed"),
    "unixDatagram" => ("A Unix datagram", "opened", "closed"),
    "Tcp listener" => ("A TCP listener", "opened", "closed"),
    "TcpLb listener" => ("A TCP listener", "opened", "closed"),
...
fn resource_close_hint(name: &str) -> &'static str {
  match name {
    ...
    "Tls listener" => "Close the TLS listener by calling `tlsListener.close()`.",
    "Unix listener" => "Close the Unix socket listener by calling `unixListener.close()`.",
    "unixDatagram" => "Close the Unix datagram socket by calling `unixDatagram.close()`.",
    "Tcp listener" => "Close the TCP listener by calling `tcpListener.close()`.",
    "TcpLb listener" => "Close the TCP listener by calling `tcpListener.close()`.",
