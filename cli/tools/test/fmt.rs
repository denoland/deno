...
pub const OP_DETAILS: phf::Map<&'static str, [&'static str; 2]> = phf_map! {
  ...
  "op_fs_flock_async" => ["lock a file", "awaiting the result of a `Deno.flock` call"],
  "op_fs_file_lock_async" => ["lock a file", "awaiting the result of a `Deno.FsFile.lock` call"],
  ...
  "op_fs_futime_async" => ["change file timestamps", "awaiting the result of a `Deno.futime` call"],
  "op_fs_write_file_async" => ["write a file", "awaiting the result of a `Deno.writeFile` call"],
  "op_fs_file_utime_async" => ["change file timestamps", "awaiting the result of a `Deno.FsFile.utime` call"],
  ...
  "op_fs_fsync_async" => ["flush pending data operations for a file to disk", "awaiting the result of a `Deno.fsync` call"],
  "op_fs_file_sync_async_unstable" => ["flush pending data operations for a file to disk", "awaiting the result of a `Deno.FsFile.sync` call"],
  "op_run_status" => ["get the status of a subprocess", "awaiting the result of a `Deno.Process#status` call"],
  "op_fs_seek_async" => ["seek in a file", "awaiting the result of a `Deno.seek` call"],
  "op_fs_file_seek_async" => ["seek in a file", "awaiting the result of a `Deno.FsFile.seek` call"],
