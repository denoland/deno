...
prepended to the SquashFS payload to form a Type-2 AppImage — when the
resulting AppImage is executed, this runtime mounts the embedded SquashFS
(via FUSE / squashfuse) and execs `AppRun` inside it.

Source: <https://github.com/AppImage/type2-runtime>
Release tag: `20251108` (downloaded 2026-04-21).
...
To refresh, download the matching assets from the same release tag, replace
the files in this directory, and update the SHA-256 table above.
