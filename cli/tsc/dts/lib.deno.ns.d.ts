...
declare namespace Deno {
  ...
  export class FsFile
     ...
     *
     * @deprecated Use {@linkcode Deno.open} or {@linkcode Deno.openSync} to
     * create a new instance of {@linkcode Deno.FsFile} instead.
     * {@linkcode Deno.FsFile} will be removed in v2.0.0.
     */
