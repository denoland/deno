...
declare module "http" {
     ...
     * @since v22.5.0
     */
    const WebSocket: import("./undici/index.d.ts").WebSocket;
    /**
     * @since v22.5.0
     */
    const CloseEvent: import("./undici/index.d.ts").CloseEvent;
    /**
     * @since v22.5.0
     */
    const MessageEvent: import("./undici/index.d.ts").MessageEvent;
}
