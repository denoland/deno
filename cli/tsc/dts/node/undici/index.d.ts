...
import {
  getGlobalDispatcher,
  setGlobalDispatcher,
} from "./global-dispatcher.d.ts";
import { getGlobalOrigin, setGlobalOrigin } from "./global-origin.d.ts";
import Pool from "./pool.d.ts";
import { DecoratorHandler, RedirectHandler } from "./handlers.d.ts";
...
import { connect, pipeline, request, stream, upgrade } from "./api.d.ts";
...
declare namespace Undici {
  ...
  const setGlobalDispatcher:
    typeof import("./global-dispatcher.d.ts").setGlobalDispatcher;
  const getGlobalDispatcher:
    typeof import("./global-dispatcher.d.ts").getGlobalDispatcher;
  ...
  const MockCallHistory:
    typeof import("./mock-call-history.d.ts").MockCallHistory;
  const MockCallHistoryLog:
    typeof import("./mock-call-history.d.ts").MockCallHistoryLog;
  ...
  const cacheStores: {
    MemoryCacheStore:
      typeof import("./cache-interceptor.d.ts").default.MemoryCacheStore;
    SqliteCacheStore:
      typeof import("./cache-interceptor.d.ts").default.SqliteCacheStore;
  };
}
