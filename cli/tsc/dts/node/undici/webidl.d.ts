...
import * as undici from "./index.d.ts";
...
export interface Webidl {
   ...
   * {@param cls} object.
   */
  brandCheck<Interface extends new () => unknown>(
    V: unknown,
    cls: Interface,
  ...
  brandCheckMultiple<Interfaces extends (new () => unknown)[]>(
    list: Interfaces,
  ): (V: any) => asserts V is Interfaces[number];
  ...
  interfaceConverter<Interface>(
    typeCheck: IsAssertion<Interface>,
    name: string,
  ): (
    V: unknown,
    prefix: string,
