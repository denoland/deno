...
declare function stream<TOpaque = null>(
  ...
  options:
    & { dispatcher?: Dispatcher }
    & Omit<Dispatcher.RequestOptions<TOpaque>, "origin" | "path">,
...
declare function pipeline<TOpaque = null>(
  ...
  options:
    & { dispatcher?: Dispatcher }
    & Omit<Dispatcher.PipelineOptions<TOpaque>, "origin" | "path">,
...
declare function connect<TOpaque = null>(
  ...
  options?:
    & { dispatcher?: Dispatcher }
    & Omit<Dispatcher.ConnectOptions<TOpaque>, "origin" | "path">,
