...
declare namespace MockCallHistoryLog {
  ...
  export type MockCallHistoryLogProperties =
    | "protocol"
    | "host"
    | "port"
    | "origin"
...
declare class MockCallHistoryLog {
  ...
  toMap(): Map<
    MockCallHistoryLog.MockCallHistoryLogProperties,
...
declare namespace MockCallHistory {
  ...
  export type FilterCallsFunctionCriteria = (
  ...
  export interface FilterCallsObjectCriteria
    extends Record<string, FilterCallsParameter> {
...
declare class MockCallHistory {
  ...
  filterCalls(
    criteria:
      | MockCallHistory.FilterCallsFunctionCriteria
      | MockCallHistory.FilterCallsObjectCriteria
      | RegExp,
    options?: MockCallHistory.FilterCallsOptions,
  ): Array<MockCallHistoryLog>;
...
export { MockCallHistory, MockCallHistoryLog };
