...
declare namespace ts {
  namespace deno {
    ...
    function setIsNodeSourceFileCallback(
      callback: IsNodeSourceFileCallback,
    ): void;
    ...
    function tryParseNpmPackageReference(
      text: string,
    ): NpmPackageReference | undefined;
  ...
  type ElementWithComputedPropertyName =
    & (ClassElement | ObjectLiteralElement)
    & {
