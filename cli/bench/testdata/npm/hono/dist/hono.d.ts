...
export declare type NotFoundHandler<E = Env> = (
  c: Context<string, E>,
) => Response | Promise<Response>;
export declare type ErrorHandler<E = Env> = (
  err: Error,
  c: Context<string, E>,
) => Response;
export declare type Next = () => Promise<void>;
declare type ParamKeyName<NameWithPattern> = NameWithPattern extends
  `${infer Name}{${infer _Pattern}` ? Name : NameWithPattern;
declare type ParamKey<Component> = Component extends `:${infer NameWithPattern}`
  ? ParamKeyName<NameWithPattern>
  : never;
declare type ParamKeys<Path> = Path extends `${infer Component}/${infer Rest}`
...
> {
  <Path extends string>(
    path: Path,
    ...handlers: Handler<
      ParamKeys<Path> extends never ? string : ParamKeys<Path>,
      E
    >[]
  ): U;
...
export declare class Hono<E extends Env = Env, P extends string = "/">
  extends Hono_base<E, P, Hono<E, P>> {
