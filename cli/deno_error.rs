  ...
  impl GetErrorKind for Error {
    fn kind(&self) -> ErrorKind {
      match self {
        ...
        Sys(EINTR) => unreachable!(),
        Sys(EIO) => unreachable!(),
        Sys(ENXIO) => unreachable!(),
        Sys(E2BIG) => unreachable!(),
        Sys(ENOEXEC) => unreachable!(),
        Sys(EBADF) => unreachable!(),
        Sys(ECHILD) => unreachable!(),
        Sys(EDEADLK) => unreachable!(),
        Sys(ENOMEM) => unreachable!(),
        Sys(EACCES) => unreachable!(),
        Sys(EFAULT) => unreachable!(),
        Sys(ENOTBLK) => unreachable!(),
        Sys(EBUSY) => unreachable!(),
        Sys(EEXIST) => unreachable!(),
        Sys(EXDEV) => unreachable!(),
        Sys(ENODEV) => unreachable!(),
        Sys(ENOTDIR) => unreachable!(),
        Sys(EISDIR) => unreachable!(),
        Sys(ENFILE) => unreachable!(),
        Sys(EMFILE) => unreachable!(),
        Sys(ENOTTY) => unreachable!(),
        Sys(ETXTBSY) => unreachable!(),
        Sys(EFBIG) => unreachable!(),
        Sys(ENOSPC) => unreachable!(),
        Sys(ESPIPE) => unreachable!(),
        Sys(EROFS) => unreachable!(),
        Sys(EMLINK) => unreachable!(),
        Sys(EPIPE) => unreachable!(),
        Sys(EDOM) => unreachable!(),
        Sys(ERANGE) => unreachable!(),
        Sys(EAGAIN) => unreachable!(),
        Sys(EINPROGRESS) => unreachable!(),
        Sys(EALREADY) => unreachable!(),
        Sys(ENOTSOCK) => unreachable!(),
        Sys(EDESTADDRREQ) => unreachable!(),
        Sys(EMSGSIZE) => unreachable!(),
        Sys(EPROTOTYPE) => unreachable!(),
        Sys(ENOPROTOOPT) => unreachable!(),
        Sys(EPROTONOSUPPORT) => unreachable!(),
        Sys(ESOCKTNOSUPPORT) => unreachable!(),
        Sys(ENOTSUP) => unreachable!(),
        Sys(EPFNOSUPPORT) => unreachable!(),
        Sys(EAFNOSUPPORT) => unreachable!(),
        Sys(EADDRINUSE) => unreachable!(),
        Sys(EADDRNOTAVAIL) => unreachable!(),
        Sys(ENETDOWN) => unreachable!(),
        Sys(ENETUNREACH) => unreachable!(),
        Sys(ENETRESET) => unreachable!(),
        Sys(ECONNABORTED) => unreachable!(),
        Sys(ECONNRESET) => unreachable!(),
        Sys(ENOBUFS) => unreachable!(),
        Sys(EISCONN) => unreachable!(),
        Sys(ENOTCONN) => unreachable!(),
        Sys(ESHUTDOWN) => unreachable!(),
        Sys(ETOOMANYREFS) => unreachable!(),
        Sys(ETIMEDOUT) => unreachable!(),
        Sys(ECONNREFUSED) => unreachable!(),
        Sys(ELOOP) => unreachable!(),
        Sys(ENAMETOOLONG) => unreachable!(),
        Sys(EHOSTDOWN) => unreachable!(),
        Sys(EHOSTUNREACH) => unreachable!(),
        Sys(ENOTEMPTY) => unreachable!(),
        Sys(EPROCLIM) => unreachable!(),
        Sys(EUSERS) => unreachable!(),
        Sys(EDQUOT) => unreachable!(),
        Sys(ESTALE) => unreachable!(),
        Sys(EREMOTE) => unreachable!(),
        Sys(EBADRPC) => unreachable!(),
        Sys(ERPCMISMATCH) => unreachable!(),
        Sys(EPROGUNAVAIL) => unreachable!(),
        Sys(EPROGMISMATCH) => unreachable!(),
        Sys(EPROCUNAVAIL) => unreachable!(),
        Sys(ENOLCK) => unreachable!(),
        Sys(ENOSYS) => unreachable!(),
        Sys(EFTYPE) => unreachable!(),
        Sys(EAUTH) => unreachable!(),
        Sys(ENEEDAUTH) => unreachable!(),
        Sys(EPWROFF) => unreachable!(),
        Sys(EDEVERR) => unreachable!(),
        Sys(EOVERFLOW) => unreachable!(),
        Sys(EBADEXEC) => unreachable!(),
        Sys(EBADARCH) => unreachable!(),
        Sys(ESHLIBVERS) => unreachable!(),
        Sys(EBADMACHO) => unreachable!(),
        Sys(ECANCELED) => unreachable!(),
        Sys(EIDRM) => unreachable!(),
        Sys(ENOMSG) => unreachable!(),
        Sys(EILSEQ) => unreachable!(),
        Sys(ENOATTR) => unreachable!(),
        Sys(EBADMSG) => unreachable!(),
        Sys(EMULTIHOP) => unreachable!(),
        Sys(ENODATA) => unreachable!(),
        Sys(ENOLINK) => unreachable!(),
        Sys(ENOSR) => unreachable!(),
        Sys(ENOSTR) => unreachable!(),
        Sys(EPROTO) => unreachable!(),
        Sys(ETIME) => unreachable!(),
        Sys(EOPNOTSUPP) => unreachable!(),
        Sys(ENOPOLICY) => unreachable!(),
