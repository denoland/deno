...
// Copied from bindings_windows_x86_64.rs: on Windows the libuv structs only
// contain pointer-sized and fixed-width fields (HANDLE, SOCKET, ULONG_PTR,
// CRITICAL_SECTION, CONDITION_VARIABLE, ...), whose layouts are identical on
// x86_64 and aarch64. The layout assertions below fail the build if that
// ever stops holding.
