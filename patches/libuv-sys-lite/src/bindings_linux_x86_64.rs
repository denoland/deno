...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
  ["Size of uv_loop_s"][::std::mem::size_of::<uv_loop_s>() - 848usize];
  ...
  ["Offset of field: uv_loop_s::wq_async"][::std::mem::offset_of!(uv_loop_s, wq_async) - 176usize];
  ["Offset of field: uv_loop_s::cloexec_lock"]
    [::std::mem::offset_of!(uv_loop_s, cloexec_lock) - 304usize];
  ["Offset of field: uv_loop_s::closing_handles"]
    [::std::mem::offset_of!(uv_loop_s, closing_handles) - 360usize];
  ["Offset of field: uv_loop_s::process_handles"]
    [::std::mem::offset_of!(uv_loop_s, process_handles) - 368usize];
  ["Offset of field: uv_loop_s::prepare_handles"]
    [::std::mem::offset_of!(uv_loop_s, prepare_handles) - 384usize];
  ["Offset of field: uv_loop_s::check_handles"]
    [::std::mem::offset_of!(uv_loop_s, check_handles) - 400usize];
  ["Offset of field: uv_loop_s::idle_handles"]
    [::std::mem::offset_of!(uv_loop_s, idle_handles) - 416usize];
  ["Offset of field: uv_loop_s::async_handles"]
    [::std::mem::offset_of!(uv_loop_s, async_handles) - 432usize];
  ["Offset of field: uv_loop_s::async_unused"]
    [::std::mem::offset_of!(uv_loop_s, async_unused) - 448usize];
  ["Offset of field: uv_loop_s::async_io_watcher"]
    [::std::mem::offset_of!(uv_loop_s, async_io_watcher) - 456usize];
  ["Offset of field: uv_loop_s::async_wfd"]
    [::std::mem::offset_of!(uv_loop_s, async_wfd) - 512usize];
  ["Offset of field: uv_loop_s::timer_heap"]
    [::std::mem::offset_of!(uv_loop_s, timer_heap) - 520usize];
  ["Offset of field: uv_loop_s::timer_counter"]
    [::std::mem::offset_of!(uv_loop_s, timer_counter) - 536usize];
  ["Offset of field: uv_loop_s::time"][::std::mem::offset_of!(uv_loop_s, time) - 544usize];
  ["Offset of field: uv_loop_s::signal_pipefd"]
    [::std::mem::offset_of!(uv_loop_s, signal_pipefd) - 552usize];
  ["Offset of field: uv_loop_s::signal_io_watcher"]
    [::std::mem::offset_of!(uv_loop_s, signal_io_watcher) - 560usize];
  ["Offset of field: uv_loop_s::child_watcher"]
    [::std::mem::offset_of!(uv_loop_s, child_watcher) - 616usize];
  ["Offset of field: uv_loop_s::emfile_fd"]
    [::std::mem::offset_of!(uv_loop_s, emfile_fd) - 768usize];
  ["Offset of field: uv_loop_s::inotify_read_watcher"]
    [::std::mem::offset_of!(uv_loop_s, inotify_read_watcher) - 776usize];
  ["Offset of field: uv_loop_s::inotify_watchers"]
    [::std::mem::offset_of!(uv_loop_s, inotify_watchers) - 832usize];
  ["Offset of field: uv_loop_s::inotify_fd"]
    [::std::mem::offset_of!(uv_loop_s, inotify_fd) - 840usize];
};
