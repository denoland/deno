...
((window) => {
  ...
  function readSync(rid, buffer) {
    ...
    const nread = core.jsonOpSync("op_read_sync", rid, buffer);
  ...
  async function read(
    ...
    const nread = await core.jsonOpAsync("op_read_async", rid, buffer);

    return nread === 0 ? null : nread;
  }

  function writeSync(rid, data) {
    return core.jsonOpSync("op_write_sync", rid, data);
  }

  async function write(rid, data) {
    return await core.jsonOpAsync("op_write_async", rid, data);
  }
