...
pub fn op_query_permission(
  ...
  let perm = match args.name.as_ref() {
    ...
    "net-connect" => permissions.query_net_connect(args.host.as_deref())?,
    "net-listen" => permissions.query_net_listen(args.host.as_deref())?,
...
pub fn op_revoke_permission(
  ...
  let perm = match args.name.as_ref() {
    ...
    "net-connect" => permissions.revoke_net_connect(args.host.as_deref())?,
    "net-listen" => permissions.revoke_net_listen(args.host.as_deref())?,
...
pub fn op_request_permission(
  ...
  let perm = match args.name.as_ref() {
    ...
    "net-connect" => permissions.request_net_connect(args.host.as_deref())?,
    "net-listen" => permissions.request_net_listen(args.host.as_deref())?,
