...
fn op_chdir(
  ...
  state.borrow_mut::<Permissions>().check_read(&d)?;
  set_current_dir(&d)?;
  Ok(json!({}))
}
...
fn op_mkdir_sync(
  ...
  state.borrow_mut::<Permissions>().check_write(&path)?;
...
fn op_stat_sync(
  ...
  state.borrow_mut::<Permissions>().check_read(&path)?;
...
fn op_symlink_sync(
  ...
  state.borrow_mut::<Permissions>().check_write(&newpath)?;
