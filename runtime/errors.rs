...
fn get_crypto_import_key_error_class(e: &ImportKeyError) -> &'static str {
  match e {
    ...
    ImportKeyError::InvalidModulus => "DataError",
    ImportKeyError::InvalidPublicExponent => "DataError",
    ImportKeyError::InvalidPrivateExponent => "DataError",
    ImportKeyError::InvalidFirstPrimeFactor => "DataError",
    ImportKeyError::InvalidSecondPrimeFactor => "DataError",
    ImportKeyError::InvalidFirstCRTExponent => "DataError",
    ImportKeyError::InvalidSecondCRTExponent => "DataError",
    ImportKeyError::InvalidCRTCoefficient => "DataError",
    ImportKeyError::InvalidB64Coordinate => "DataError",
    ImportKeyError::InvalidRSAPublicKey => "DataError",
    ImportKeyError::InvalidRSAPrivateKey => "DataError",
    ImportKeyError::UnsupportedAlgorithm => "DataError",
    ImportKeyError::PublicKeyTooLong => "DataError",
    ImportKeyError::PrivateKeyTooLong => "DataError",
    ImportKeyError::InvalidP256ECPoint => "DataError",
    ImportKeyError::InvalidP384ECPoint => "DataError",
    ImportKeyError::InvalidP521ECPoint => "DataError",
    ImportKeyError::UnsupportedNamedCurve => "DataError",
    ImportKeyError::CurveMismatch => "DataError",
    ImportKeyError::InvalidKeyData => "DataError",
    ImportKeyError::InvalidJWKPrivateKey => "DataError",
    ImportKeyError::EllipticCurve(_) => "DataError",
    ImportKeyError::ExpectedValidPkcs8Data => "DataError",
    ImportKeyError::MalformedParameters => "DataError",
    ImportKeyError::Spki(_) => "DataError",
    ImportKeyError::InvalidP256ECSPKIData => "DataError",
    ImportKeyError::InvalidP384ECSPKIData => "DataError",
    ImportKeyError::InvalidP521ECSPKIData => "DataError",
    ImportKeyError::Der(_) => "DataError",
  }
}
