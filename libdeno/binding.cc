...
v8::Local<v8::ObjectTemplate> CreateGlobalTemplate(v8::Isolate* isolate) {
  ...
  auto worker_fun_template =
      v8::FunctionTemplate::New(isolate, v8::Shell::WorkerNew);
  ...
  worker_fun_template->PrototypeTemplate()->Set(
      deno::v8_str("terminate"),
      v8::FunctionTemplate::New(isolate, v8::Shell::WorkerTerminate,
                                v8::Local<v8::Value>(), worker_signature));
  worker_fun_template->PrototypeTemplate()->Set(
      deno::v8_str("postMessage"),
      v8::FunctionTemplate::New(isolate, v8::Shell::WorkerPostMessage,
                                v8::Local<v8::Value>(), worker_signature));
  worker_fun_template->PrototypeTemplate()->Set(
      deno::v8_str("getMessage"),
      v8::FunctionTemplate::New(isolate, v8::Shell::WorkerGetMessage,
                                v8::Local<v8::Value>(), worker_signature));
