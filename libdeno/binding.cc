...
v8::Local<v8::ObjectTemplate> CreateGlobalTemplate(v8::Isolate* isolate) {
  ...
  auto worker_fun_template =
      v8::FunctionTemplate::New(isolate, deno::WorkerNew);
//  auto worker_signature = v8::Signature::New(isolate, worker_fun_template);
  ...
  //     v8::FunctionTemplate::New(isolate, deno::WorkerTerminate,
  //                               v8::Local<v8::Value>(), worker_signature));
  // worker_fun_template->PrototypeTemplate()->Set(
  //     deno::v8_str("postMessage"),
  //     v8::FunctionTemplate::New(isolate, deno::WorkerPostMessage,
  //                               v8::Local<v8::Value>(), worker_signature));
  // worker_fun_template->PrototypeTemplate()->Set(
  //     deno::v8_str("getMessage"),
  //     v8::FunctionTemplate::New(isolate, deno::WorkerGetMessage,
  //                               v8::Local<v8::Value>(), worker_signature));
