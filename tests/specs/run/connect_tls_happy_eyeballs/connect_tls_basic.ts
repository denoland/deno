// Test Deno.connectTls with Happy Eyeballs options
...
// Connect with default Happy Eyeballs options
const conn = await Deno.connectTls({
  hostname,
  port: addr.port,
  // autoSelectFamily defaults to true
});
...
console.log("TLS connect with Happy Eyeballs: OK");
