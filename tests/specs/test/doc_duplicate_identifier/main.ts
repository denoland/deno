...
// However, this automatic import resolution might conflict with other explicit
// imports in the test code you write. This spec test exists to make sure that
// such cases will not cause any issues - explicit imports take precedence.

/**
 * ```ts
 * import { assertEquals } from "@std/assert/equals";
 * import { getModuleName } from "./mod.ts";
 *
