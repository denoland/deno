...
const good = [
  /* TODO(kt3k): Node.js allows keylen === 0
...
/* TODO(kt3k): Currently Deno throws with generic invalid scrypt params error
...
/* TODO(kt3k): Deno does not allow keylen === 1
{
